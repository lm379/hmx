...
type PresignRequest struct {
	...
	UploadType  string `json:"upload_type" binding:"required"` // 'user_avatar', 'artist_avatar', 'opera_cover', 'news_cover', 'education_pdf', 'education_cover', 'video_upload'
	TargetID    uint   `json:"target_id"`                      // 目标ID：用户ID、艺术家ID或曲目ID；news_cover/education_pdf/education_cover/video_upload 可为0
}
